...
public class ArrayOfWorkflowRequestTableRecord  implements java.io.Serializable {
    private com.WorkflowRequestTableRecord[] workflowRequestTableRecord;

    public ArrayOfWorkflowRequestTableRecord() {
    }

    public ArrayOfWorkflowRequestTableRecord(
           com.WorkflowRequestTableRecord[] workflowRequestTableRecord) {
     ...
     */
    public com.WorkflowRequestTableRecord[] getWorkflowRequestTableRecord() {
        return workflowRequestTableRecord;
    }
     ...
     */
    public void setWorkflowRequestTableRecord(com.WorkflowRequestTableRecord[] workflowRequestTableRecord) {
        this.workflowRequestTableRecord = workflowRequestTableRecord;
    }

    public com.WorkflowRequestTableRecord getWorkflowRequestTableRecord(int i) {
        return this.workflowRequestTableRecord[i];
    }

    public void setWorkflowRequestTableRecord(int i, com.WorkflowRequestTableRecord _value) {
