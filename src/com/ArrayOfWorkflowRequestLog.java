...
public class ArrayOfWorkflowRequestLog  implements java.io.Serializable {
    private com.WorkflowRequestLog[] workflowRequestLog;

    public ArrayOfWorkflowRequestLog() {
    }

    public ArrayOfWorkflowRequestLog(
           com.WorkflowRequestLog[] workflowRequestLog) {
     ...
     */
    public com.WorkflowRequestLog[] getWorkflowRequestLog() {
        return workflowRequestLog;
    }
     ...
     */
    public void setWorkflowRequestLog(com.WorkflowRequestLog[] workflowRequestLog) {
        this.workflowRequestLog = workflowRequestLog;
    }

    public com.WorkflowRequestLog getWorkflowRequestLog(int i) {
        return this.workflowRequestLog[i];
    }

    public void setWorkflowRequestLog(int i, com.WorkflowRequestLog _value) {
