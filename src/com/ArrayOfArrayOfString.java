...
public class ArrayOfArrayOfString  implements java.io.Serializable {
    private com.ArrayOfString[] arrayOfString;

    public ArrayOfArrayOfString() {
    }

    public ArrayOfArrayOfString(
           com.ArrayOfString[] arrayOfString) {
     ...
     */
    public com.ArrayOfString[] getArrayOfString() {
        return arrayOfString;
    }
     ...
     * @param arrayOfString
     */
    public void setArrayOfString(com.ArrayOfString[] arrayOfString) {
        this.arrayOfString = arrayOfString;
    }

    public com.ArrayOfString getArrayOfString(int i) {
        return this.arrayOfString[i];
    }

    public void setArrayOfString(int i, com.ArrayOfString _value) {
