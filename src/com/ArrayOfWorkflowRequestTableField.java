...
public class ArrayOfWorkflowRequestTableField  implements java.io.Serializable {
    private com.WorkflowRequestTableField[] workflowRequestTableField;

    public ArrayOfWorkflowRequestTableField() {
    }

    public ArrayOfWorkflowRequestTableField(
           com.WorkflowRequestTableField[] workflowRequestTableField) {
     ...
     */
    public com.WorkflowRequestTableField[] getWorkflowRequestTableField() {
        return workflowRequestTableField;
    }
     ...
     */
    public void setWorkflowRequestTableField(com.WorkflowRequestTableField[] workflowRequestTableField) {
        this.workflowRequestTableField = workflowRequestTableField;
    }

    public com.WorkflowRequestTableField getWorkflowRequestTableField(int i) {
        return this.workflowRequestTableField[i];
    }

    public void setWorkflowRequestTableField(int i, com.WorkflowRequestTableField _value) {
