...
public class ArrayOfWorkflowDetailTableInfo  implements java.io.Serializable {
    private com.WorkflowDetailTableInfo[] workflowDetailTableInfo;

    public ArrayOfWorkflowDetailTableInfo() {
    }

    public ArrayOfWorkflowDetailTableInfo(
           com.WorkflowDetailTableInfo[] workflowDetailTableInfo) {
     ...
     */
    public com.WorkflowDetailTableInfo[] getWorkflowDetailTableInfo() {
        return workflowDetailTableInfo;
    }
     ...
     */
    public void setWorkflowDetailTableInfo(com.WorkflowDetailTableInfo[] workflowDetailTableInfo) {
        this.workflowDetailTableInfo = workflowDetailTableInfo;
    }

    public com.WorkflowDetailTableInfo getWorkflowDetailTableInfo(int i) {
        return this.workflowDetailTableInfo[i];
    }

    public void setWorkflowDetailTableInfo(int i, com.WorkflowDetailTableInfo _value) {
