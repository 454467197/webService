...
public class WorkflowServiceLocator extends org.apache.axis.client.Service implements com.WorkflowService {
    ...
    private java.lang.String WorkflowServiceHttpPort_address = "http://192.168.2.6/services/WorkflowService";
    ...
    public com.WorkflowServicePortType getWorkflowServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.WorkflowServicePortType getWorkflowServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.WorkflowServiceHttpBindingStub _stub = new com.WorkflowServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.WorkflowServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.WorkflowServiceHttpBindingStub _stub = new com.WorkflowServiceHttpBindingStub(new java.net.URL(WorkflowServiceHttpPort_address), this);
                _stub.setPortName(getWorkflowServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
